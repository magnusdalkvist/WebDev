...
<section class="flex flex-col items-center ">
  <div class="py-8 px-8 md:mt-10 md:w-1/3 bg-50-shades text-soft-white rounded-md">
    ...
    <form onsubmit="validate(partner_signup); return false" class="flex flex-col text-slate-500">
      <div class="grid">
        ...
        <label for="user_name" class="flex items-center bg-soft-white px-4 py-3 rounded-2xl text-mr-grey">
      ...
      <div class="grid">
        ...
        <label for="user_last_name" class="flex items-center bg-soft-white px-4 py-3 rounded-2xl text-mr-grey">
      ...
      <div class="grid mt-4">
        ...
        <label for="partner_name" class="flex items-center bg-soft-white px-4 py-3 rounded-2xl text-mr-grey">
      ...
      <div class="grid">
        ...
        <label for="user_email" class="flex items-center bg-soft-white px-4 py-3 rounded-2xl text-mr-grey">
      ...
      <div class="grid">
        ...
        <label for="user_password" class="flex items-center bg-soft-white px-4 py-3 rounded-2xl text-mr-grey">
      ...
      <div class="grid">
        ...
        <label for="user_confirm_password" class="flex items-center bg-soft-white px-4 py-3 rounded-2xl text-mr-grey">
