...
<body oncontextmenu="toogle_menu(); return false" class="w-full h-screen text-base text-gray-900 font-roboto font-light bg-gray-300 
  ...
  <nav class="flex items-center w-full h-16 px-4 md:px-12 lg:px-44 border-b border-b-zinc-500">
    ...
    <div class="relative ml-auto">
      <button class="flex items-center" onclick="toggle_language()">
        <svg class="w-5 h-5 mr-2 rounded-full" aria-hidden="true" viewBox="0 0 3900 3900">
      ...
      <div id="box_languages" class="hidden absolute flex flex-col gap-2 top-8 p-2 -left-2 bg-zinc-400 dark:bg-zinc-600 rounded-sm">
        <button class="flex items-center">
          <svg class="w-5 h-5 rounded-full mr-2" aria-hidden="true" id="flag-icon-css-de" viewBox="0 0 512 512">
        ...
        <button class="flex items-center">
          <svg class="w-5 h-5  rounded-full mr-2" aria-hidden="true" id="flag-icon-css-it" viewBox="0 0 512 512">
        ...
        <button class="flex items-center">
          <svg class="w-5 h-5 rounded-full mr-2" viewBox="0 0 280 280">
            <rect width="370" height="280" fill="#c60c30" />
            <rect width="40" height="280" x="80" fill="#fff" />
    ...
    <button onclick="toggle_theme()" class="ml-4 border-2 border-zinc-500 rounded-md p-1">
      <svg id="btn_dark_icon" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
      </svg>
      <svg id="btn_light_icon" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        <path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" fill-rule="evenodd" clip-rule="evenodd"></path>
      </svg>
    </button>
    <svg onclick="toogle_menu()" class="ml-4 cursor-pointer" width="32" height="32" viewBox="0 0 24 24">
